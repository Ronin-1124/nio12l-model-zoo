...
_calib_dir = os.path.join(_here, "..", "..", "..", "calibration_dataset", "640")

converter = mtk_converter.OnnxConverter.from_model_proto_file(
    model_proto_file=os.path.join(_here, "yolov8n-seg_10head.onnx"),
    input_names=["images"],
...
converter.convert_to_tflite(
    output_file=os.path.join(_here, "..", "model", "int8", "yolov8n-seg_mtk_int8.tflite"),
