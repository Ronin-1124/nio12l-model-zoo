...
inline const std::string kDefaultInt8ModelPath = "models/yolov8n-seg/int8/yolov8n-seg_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/yolov8n-seg/fp32/yolov8n-seg_fp32.dla";
