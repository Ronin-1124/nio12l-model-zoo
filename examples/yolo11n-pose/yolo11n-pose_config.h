...
inline const std::string kDefaultInt8ModelPath = "models/yolo11n-pose/int8/yolo11n-pose_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/yolo11n-pose/fp32/yolo11n-pose_fp32.dla";
