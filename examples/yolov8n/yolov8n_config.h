...
inline const std::string kDefaultInt8ModelPath = "examples/yolov8n/model/int8/yolov8n_int8.dla";
inline const std::string kDefaultFp32ModelPath = "examples/yolov8n/model/fp32/yolov8n_fp32.dla";
