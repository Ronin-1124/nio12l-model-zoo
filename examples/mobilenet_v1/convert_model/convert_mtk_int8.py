...
def data_gen():
    ...
    for fn in sorted(os.listdir(_calib_dir)):
        ...
        # prepare_calibration_data outputs NCHW, transpose to NHWC
        yield [im.transpose(0, 2, 3, 1)]


converter.quantize = True
converter.calibration_data_gen = data_gen
converter.convert_to_tflite(
    output_file=os.path.join(_here, "..", "model", "int8", "mobilenet_v1_1.0_224_mtk_int8.tflite"),
