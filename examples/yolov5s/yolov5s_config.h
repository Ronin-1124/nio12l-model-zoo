...
inline const std::string kDefaultInt8ModelPath = "models/yolov5s/int8/yolov5s_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/yolov5s/fp32/yolov5s_fp32.dla";
