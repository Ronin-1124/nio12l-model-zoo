...
inline const std::string kDefaultInt8ModelPath = "models/mobilenet_v3_small/int8/mobilenet_v3_small_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/mobilenet_v3_small/fp32/mobilenet_v3_small_fp32.dla";
