...
inline const std::string kDefaultInt8ModelPath = "examples/yolov8n-obb/model/int8/yolov8n-obb_int8.dla";
inline const std::string kDefaultFp32ModelPath = "examples/yolov8n-obb/model/fp32/yolov8n-obb_fp32.dla";
