...
inline const std::string kDefaultInt8ModelPath = "examples/yolo11n/model/int8/yolo11n_int8.dla";
inline const std::string kDefaultFp32ModelPath = "examples/yolo11n/model/fp32/yolo11n_fp32.dla";
