...
inline const std::string kDefaultInt8ModelPath = "models/mobilenet_v2/int8/mobilenet_v2_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/mobilenet_v2/fp32/mobilenet_v2_fp32.dla";
