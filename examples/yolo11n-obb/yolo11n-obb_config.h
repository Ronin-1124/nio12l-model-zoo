...
inline const std::string kDefaultInt8ModelPath = "examples/yolo11n-obb/model/int8/yolo11n-obb_int8.dla";
inline const std::string kDefaultFp32ModelPath = "examples/yolo11n-obb/model/fp32/yolo11n-obb_fp32.dla";
