...
inline const std::string kDefaultInt8ModelPath = "models/yolo11n-seg/int8/yolo11n-seg_int8.dla";
inline const std::string kDefaultFp32ModelPath = "models/yolo11n-seg/fp32/yolo11n-seg_fp32.dla";
